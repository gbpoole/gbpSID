...
#
# set_active_API_module      mpi Message Passing Interface (MPI)
...
list(APPEND SRCFILES "SID_Isend.c")
list(APPEND SRCFILES "SID_Ssend.c")
list(APPEND SRCFILES "SID_Recv.c")
list(APPEND SRCFILES "SID_Irecv.c")
list(APPEND SRCFILES "SID_Sendrecv.c")
list(APPEND SRCFILES "SID_Probe.c")
list(APPEND SRCFILES "SID_Reduce.c")
list(APPEND SRCFILES "SID_Allreduce.c")
list(APPEND SRCFILES "SID_Allgather.c")
list(APPEND SRCFILES "SID_Allgatherv.c")
list(APPEND SRCFILES "SID_Gatherv.c")
