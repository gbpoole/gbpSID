...
# Find header files
find_path(FFTW3_INCLUDES fftw3.h HINTS "${FFTW_ROOT}/*")
...
if(USE_MPI)
    if(USE_DOUBLE)
        find_library(FFTW3_FIND_QUIETLY_MPI_LIBRARY fftw3_mpi HINTS "${FFTW3_ROOT}/*")
        find_library(FFTW3_MPI_LIBRARY NAMES fftw3_mpi)
    else()
        find_library(FFTW3_MPI_LIBRARY fftw3f_mpi HINTS "${FFTW3_ROOT}/*")
...
if(USE_DOUBLE)
    ...
    find_library(FFTW3_LIBRARY fftw3f HINTS "${FFTW3_ROOT}/*" )
