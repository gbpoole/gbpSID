...
if(USE_MPI)
    if(USE_DOUBLE)
        find_library(FFTW2_MPI_LIBRARY dfftw_mpi PATHS "${FFTW_ROOT}/*" NO_DEFAULT_PATH)
        find_library(FFTW2_MPI_LIBRARY NAMES dfftw_mpi)
        list(APPEND FFTW2_LIBRARIES ${FFTW2_MPI_LIBRARY} )
        find_library(FFTW2_MPI_LIBRARY_R drfftw_mpi PATHS "${FFTW_ROOT}/*" NO_DEFAULT_PATH)
        find_library(FFTW2_MPI_LIBRARY_R NAMES drfftw_mpi)
        list(APPEND FFTW2_LIBRARIES ${FFTW2_MPI_LIBRARY_R} )
    else()
        find_library(FFTW2_MPI_LIBRARY sfftw_mpi PATHS "${FFTW_ROOT}/*" NO_DEFAULT_PATH)
        find_library(FFTW2_MPI_LIBRARY NAMES sfftw_mpi)
        list(APPEND FFTW2_LIBRARIES ${FFTW2_MPI_LIBRARY} )
        find_library(FFTW2_MPI_LIBRARY_R srfftw_mpi PATHS "${FFTW_ROOT}/*" NO_DEFAULT_PATH)
...
if(USE_DOUBLE)
    find_library(FFTW2_LIBRARY dfftw PATHS "${FFTW_ROOT}/*" NO_DEFAULT_PATH)
    find_library(FFTW2_LIBRARY NAMES dfftw)
    list(APPEND FFTW2_LIBRARIES ${FFTW2_LIBRARY} )
    find_library(FFTW2_LIBRARY_R dfftw PATHS "${FFTW_ROOT}/*" NO_DEFAULT_PATH)
    find_library(FFTW2_LIBRARY_R NAMES dfftw)
    list(APPEND FFTW2_LIBRARIES ${FFTW2_LIBRARY_R} )
else()
    find_library(FFTW2_LIBRARY sfftw PATHS "${FFTW_ROOT}/*" NO_DEFAULT_PATH)
    find_library(FFTW2_LIBRARY NAMES sfftw)
    list(APPEND FFTW2_LIBRARIES ${FFTW2_LIBRARY} )
    find_library(FFTW2_LIBRARY_R srfftw PATHS "${FFTW_ROOT}/*" NO_DEFAULT_PATH)
